    ...
    <div className="sticky top-[64px] md:top-[72px] z-30 bg-[var(--bg-raised)] border-b border-[var(--white-08)] font-body select-none">
      <div className="container-custom flex items-center justify-between h-14">
        ...
        <div className="flex items-center gap-2 pl-4 shrink-0">
          <label htmlFor="sort" className="text-xs text-[var(--white-60)] font-medium">
            Sort:
          </label>
          <select
            id="sort"
            className="bg-transparent border-none text-[var(--white-60)] hover:text-white text-xs font-bold uppercase tracking-wider focus:outline-none cursor-pointer h-8"
            value={activeSort}
