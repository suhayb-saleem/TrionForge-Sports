...
When you visit our Site, certain technical information may be collected automatically, including:
- IP address
...
This information may be collected via cookies and similar technologies (see Section 5).

### 3.3 Information from Third-Party Services
We use trusted third-party service providers to help operate our Site and business communications, including services for website hosting, security and performance, email delivery, and business communications. These providers process data solely on our behalf and are contractually or by policy bound to protect your information in accordance with applicable data protection standards.

[If you add Google Analytics or any other analytics/marketing tool, add a corresponding entry here before publishing.]

## 4. How We Use Your Information

We use collected information to:
- Respond to inquiries submitted through our contact form
- Provide quotes, product information, and communicate about potential business relationships
- Improve and maintain the security and performance of our Site
...
[If you add any non-essential cookies — analytics, marketing, advertising — you are required under GDPR/ePrivacy rules to obtain explicit consent via a cookie banner before they load. Add a cookie consent mechanism and update this section accordingly if/when you do.]
...
## 6. Legal Basis for Processing (EU/EEA Visitors — GDPR)
...
- **Legitimate interest** — for security/fraud prevention (e.g., Cloudflare bot protection) and responding to business inquiries
- **Contractual necessity** — where processing is necessary to take steps toward a potential business relationship at your request

### Your Rights Under GDPR
If applicable to you, you have the right to:
