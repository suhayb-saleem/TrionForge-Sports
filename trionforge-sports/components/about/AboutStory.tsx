    ...
    <section style={{ background: '#0a0a0a', padding: '6rem 1.5rem' }}>
      <div style={{ maxWidth: '1280px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
        ...
        <motion.div
          ...
          style={{ aspectRatio: '4/3', background: '#1a1a1a', border: '1px solid rgba(255,255,255,0.08)', position: 'relative', overflow: 'hidden' }}
        >
          {/* Replace with next/image when photo available */}
          <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <span style={{ color: '#8A8A8A', fontSize: '0.75rem', fontFamily: 'var(--font-body)', letterSpacing: '0.1em' }}>FACTORY PHOTO</span>
          </div>
        </motion.div>
        ...
        >
          ...
          <p style={{ color: '#C8C8C8', fontSize: '1rem', lineHeight: 1.75, fontFamily: 'var(--font-body)', marginBottom: '1.25rem' }}>
          ...
          <p style={{ color: '#C8C8C8', fontSize: '1rem', lineHeight: 1.75, fontFamily: 'var(--font-body)', marginBottom: '2rem' }}>
