  ...
  return (
    <section style={{ background: '#0f0f0f', minHeight: '320px', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center', paddingTop: '120px', paddingBottom: '4rem' }}>
      <div>
        ...
        <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }} style={{ color: '#C8C8C8', fontSize: '1.125rem', fontFamily: 'var(--font-body)', maxWidth: '520px' }}>
